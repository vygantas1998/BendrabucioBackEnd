      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            if (conn) conn.end();
            _context3.t0 = table;
            _context3.next = _context3.t0 === "shower" ? 15 : _context3.t0 === "shower_reservation" ? 16 : _context3.t0 === "washing_machine" ? 17 : 18;
            break;

          case 15:
            return _context3.abrupt("return", new _types.Shower(rows[0]));

          case 16:
            return _context3.abrupt("return", new _types.ShowerReservation(rows[0]));

          case 17:
            return _context3.abrupt("return", new _types.WashingMachine(rows[0]));
